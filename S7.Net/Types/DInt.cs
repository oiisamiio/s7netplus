...
namespace S7.Net.Types
{
    public static class DInt
    {
        ...
        //support for dynamic byte address
        public static Int32 FromByteArray(byte[] bytes, int index)
        {
            return FromBytes(bytes[index + 3], bytes[index + 2], bytes[index + 1], bytes[index + 0]);
        }
        ...
        public static byte[] ToByteArray(Int32 value)
        {
            ...
            byte[] bytes = Conversion.SwapByte(BitConverter.GetBytes(value), 4);
